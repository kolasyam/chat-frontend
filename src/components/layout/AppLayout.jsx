...
//       };
//     }, [socket, newMessageAlertListener, newRequestListener, RefetchListener]);
//     return (
//       <>
//         <Title />
//         <Header />
...
const AppLayout = () => (WrappedComponent) => {
  return (props) => {
    ...
    const handleDeleteChat = (e,chatId, groupChat) => {
      ...
      deleteMenuAnchor.current = e.currentTarget; // Set current target as the anchor
    ...
    }, [socket, newMessageAlertListener, newRequestListener, RefetchListener,onlineUsersListener]);
